        ...
        if ("undefined" != typeof this.isScrolling && !this.isScrolling) {
            ...
            if((id == 'page-id-2' && i == 1) ||
               (id == 'page-id-4' && i == -1)
                ...
                if(id == 'page-id-4' && i == -1){
                    // 隐藏新财富学院页面
                    xueYuanPage4View().hide();
                }else if(id == 'page-id-2' && i == 1){

                }

                //if(!isShowPhotoPage){
                    //bindPagePhotoView(0); // 只保证执行一次
                //}
                ...
                if(id == 'page-id-3' && i == 1){
                    ...
                    photoPage3View().hide();
                    // 显示page4 新财富学院
                    xueYuanPage4View().show();

                }else if(id == 'page-id-5' && i == -1){
                    // 隐藏投研圈
                    touPage5View().hide();
                    // 显示学院
                    xueYuanPage4View().show();
                ...
                touPage5View().hide();
                // 二维码显示
                qrCodePage6View().show();
                jsArrowDown.style.display = 'none';
            }else if(id == 'page-id-6' && i == 1){
                jsArrowDown.style.display = 'none';
            }else if(id == 'page-id-6' && i == -1){
                // 投研圈显示
                touPage5View().show();
                // 二维码隐藏
                qrCodePage6View().hide();
                jsArrowDown.style.display = 'block';
            }
