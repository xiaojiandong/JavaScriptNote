...
export default {
    ...
    // 修正后的设置，获取，清除cookie
      // 设置cookie
      setCookie1 : function(name, value, seconds) {
       ...
       getCookie1 : function(name) {
        ...
        // 清除cookie
        clearCookie1 : function(name) {
            SubjUtil.setCookie(name, "", -1);
        },
    /**
     * H5本地存储
     * @param key
    ...
    isMobileDevice : function(){
        var dType = this.getUaDeviceType();
        if(dType != 'pc'){
            return true;
        }else{
            return false;
    ...
    isLogin : function(){
        var yesLogin;
        this.jqAjaxGetLocal('test_login_data',function(res){
